# Copilot instructions for InfiniteZoomDrawing

## Project overview
- This repository is a single-module Android app written in Kotlin.
- The main drawing behavior lives in `app/src/main/java/com/example/infinitezoomdrawing/DrawingView.kt`.
- `app/src/main/java/com/example/infinitezoomdrawing/MainActivity.kt` wires the toolbar, tool controls, and actions around `DrawingView`.
...
- Keep drawing interaction logic in `DrawingView.kt` and activity-level UI wiring in `app/src/main/java/com/example/infinitezoomdrawing/MainActivity.kt`.
...
- If you change drawing or gesture behavior, also review the instrumentation coverage in `app/src/androidTest/java/com/example/infinitezoomdrawing/`.
